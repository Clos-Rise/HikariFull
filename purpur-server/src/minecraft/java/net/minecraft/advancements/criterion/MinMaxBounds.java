...
public interface MinMaxBounds<T extends Number & Comparable<T>> {
    ...
    record Bounds<T extends Number & Comparable<T>>(Optional<T> min, Optional<T> max) {
        ...
        static <B extends ByteBuf, T extends Number & Comparable<T>> StreamCodec<B, MinMaxBounds.Bounds<T>> createStreamCodec(
            final StreamCodec<B, T> numberCodec
        ) {
    ...
    record Doubles(@Override MinMaxBounds.Bounds<Double> bounds, MinMaxBounds.Bounds<Double> boundsSqr) implements MinMaxBounds<Double> {
    ...
    record FloatDegrees(@Override MinMaxBounds.Bounds<Float> bounds) implements MinMaxBounds<Float> {
    ...
    record Ints(@Override MinMaxBounds.Bounds<Integer> bounds, MinMaxBounds.Bounds<Long> boundsSqr) implements MinMaxBounds<Integer> {
