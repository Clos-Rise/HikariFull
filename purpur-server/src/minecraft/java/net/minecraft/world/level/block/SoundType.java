...
public class SoundType {
    ...
    public static final SoundType COPPER_GOLEM_STATUE = new SoundType(
        1.0F,
        1.0F,
        SoundEvents.COPPER_GOLEM_STATUE_BREAK,
        SoundEvents.COPPER_GOLEM_STATUE_STEP,
        SoundEvents.COPPER_GOLEM_STATUE_PLACE,
        SoundEvents.COPPER_GOLEM_STATUE_HIT,
        SoundEvents.COPPER_GOLEM_STATUE_FALL
    );
    ...
    public static final SoundType CACTUS_FLOWER = new SoundType(
        1.0F, 1.0F, SoundEvents.CACTUS_FLOWER_BREAK, SoundEvents.EMPTY, SoundEvents.CACTUS_FLOWER_PLACE, SoundEvents.EMPTY, SoundEvents.EMPTY
    );
    ...
    public static final SoundType LEAF_LITTER = new SoundType(
        1.0F,
        1.0F,
        SoundEvents.LEAF_LITTER_BREAK,
        SoundEvents.LEAF_LITTER_STEP,
        SoundEvents.LEAF_LITTER_PLACE,
        SoundEvents.LEAF_LITTER_HIT,
        SoundEvents.LEAF_LITTER_FALL
    );
    ...
    public static final SoundType SHELF = new SoundType(
        1.0F, 1.0F, SoundEvents.SHELF_BREAK, SoundEvents.SHELF_STEP, SoundEvents.SHELF_PLACE, SoundEvents.SHELF_HIT, SoundEvents.SHELF_FALL
    );
    ...
    public static final SoundType IRON = new SoundType(
        1.0F, 1.0F, SoundEvents.IRON_BREAK, SoundEvents.IRON_STEP, SoundEvents.IRON_PLACE, SoundEvents.IRON_HIT, SoundEvents.IRON_FALL
    );
    public static final SoundType DRIED_GHAST = new SoundType(
        1.0F, 1.0F, SoundEvents.DRIED_GHAST_BREAK, SoundEvents.DRIED_GHAST_STEP, SoundEvents.EMPTY, SoundEvents.EMPTY, SoundEvents.DRIED_GHAST_FALL
    );
    ...
    public SoundType(
        ...
        final SoundEvent hitSound,
        final SoundEvent fallSound
    ) {
        this.volume = volume;
        this.pitch = pitch;
