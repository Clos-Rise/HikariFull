...
public class AxisAlignedLinearPosTest extends PosRuleTest {
    public static final MapCodec<AxisAlignedLinearPosTest> CODEC = RecordCodecBuilder.mapCodec(
        i -> i.group(
                Codec.FLOAT.fieldOf("min_chance").orElse(0.0F).forGetter(p -> p.minChance),
                Codec.FLOAT.fieldOf("max_chance").orElse(0.0F).forGetter(p -> p.maxChance),
                Codec.INT.fieldOf("min_dist").orElse(0).forGetter(p -> p.minDist),
                Codec.INT.fieldOf("max_dist").orElse(0).forGetter(p -> p.maxDist),
                Direction.Axis.CODEC.fieldOf("axis").orElse(Direction.Axis.Y).forGetter(p -> p.axis)
            )
