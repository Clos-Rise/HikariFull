...
public class SurfaceRules {
    ...
    public static SurfaceRules.ConditionSource noiseCondition(
    ...
    private static final class BiomeConditionSource implements SurfaceRules.ConditionSource {
        ...
        public boolean equals(final Object o) {
            return this == o || o instanceof SurfaceRules.BiomeConditionSource that && this.biomes.equals(that.biomes);
        }
    ...
    public static final class Context {
        ...
        protected void updateY(
            final int stoneDepthAbove, final int stoneDepthBelow, final int waterHeight, final int blockX, final int blockY, final int blockZ
        ) {
            this.lastUpdateY++;
