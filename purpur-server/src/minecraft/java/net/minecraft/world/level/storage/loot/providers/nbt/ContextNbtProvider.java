...
public class ContextNbtProvider implements NbtProvider {
    ...
    private record BlockEntitySource(@Override ContextKey<? extends BlockEntity> contextParam) implements LootContextArg.Getter<BlockEntity, Tag> {
        @Override
    ...
    private record EntitySource(@Override ContextKey<? extends Entity> contextParam) implements LootContextArg.Getter<Entity, Tag> {
        @Override
