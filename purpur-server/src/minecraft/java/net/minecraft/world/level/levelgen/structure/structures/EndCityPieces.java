                ...
                for (Tuple<Rotation, BlockPos> bridge : EndCityPieces.TOWER_BRIDGES) {
                    if (random.nextBoolean()) {
                        EndCityPieces.EndCityPiece bridgeStart = EndCityPieces.addHelper(
                            pieces,
                            EndCityPieces.addPiece(structureTemplateManager, bridgePiece, bridge.getB(), "bridge_end", rotation.getRotated(bridge.getA()), true)
                        );
            ...
            for (int i = 0; i < 2 && random.nextInt(3) != 0; i++) {
                ...
                for (Tuple<Rotation, BlockPos> bridge : EndCityPieces.FAT_TOWER_BRIDGES) {
                    if (random.nextBoolean()) {
                        EndCityPieces.EndCityPiece bridgeStart = EndCityPieces.addHelper(
                            pieces,
                            EndCityPieces.addPiece(structureTemplateManager, lastPiece, bridge.getB(), "bridge_end", rotation.getRotated(bridge.getA()), true)
                        );
                        EndCityPieces.recursiveChildren(
                            structureTemplateManager, EndCityPieces.TOWER_BRIDGE_GENERATOR, genDepth + 1, bridgeStart, null, pieces, random
                        );
