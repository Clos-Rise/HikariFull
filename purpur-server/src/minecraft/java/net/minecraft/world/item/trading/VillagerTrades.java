...
public class VillagerTrades {
    ...
    public static Holder<VillagerTrade> bootstrap(final BootstrapContext<VillagerTrade> context) {
        ...
        register(
            ...
            new VillagerTrade(
                new TradeCost(Items.ARROW, 5),
                Optional.of(new TradeCost(Items.EMERALD, 2)),
        ...
        register(
            ...
            new VillagerTrade(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.YELLOW_CANDLE), 12, 30, 0.05F, Optional.empty(), List.of())
        );
        register(
            context,
            LIBRARIAN_5_EMERALD_RED_CANDLE,
            new VillagerTrade(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.RED_CANDLE), 12, 30, 0.05F, Optional.empty(), List.of())
        );
        register(
            context,
        ...
        for (Pair<ResourceKey<VillagerTrade>, Item> pair : List.of(
            Pair.of(WANDERING_TRADER_EMERALD_ACACIA_LOG, Items.ACACIA_LOG),
            Pair.of(WANDERING_TRADER_EMERALD_BIRCH_LOG, Items.BIRCH_LOG),
            Pair.of(WANDERING_TRADER_EMERALD_DARK_OAK_LOG, Items.DARK_OAK_LOG),
            Pair.of(WANDERING_TRADER_EMERALD_JUNGLE_LOG, Items.JUNGLE_LOG),
            Pair.of(WANDERING_TRADER_EMERALD_OAK_LOG, Items.OAK_LOG),
            Pair.of(WANDERING_TRADER_EMERALD_SPRUCE_LOG, Items.SPRUCE_LOG),
            Pair.of(WANDERING_TRADER_EMERALD_CHERRY_LOG, Items.CHERRY_LOG),
            Pair.of(WANDERING_TRADER_EMERALD_MANGROVE_LOG, Items.MANGROVE_LOG),
            Pair.of(WANDERING_TRADER_EMERALD_PALE_OAK_LOG, Items.PALE_OAK_LOG)
        )) {
            context.register(
                pair.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(pair.getRight(), 8), 4, 1, 0.05F, Optional.empty(), List.of())
            );
        }
        ...
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(WANDERING_TRADER_EMERALD_BRAIN_CORAL_BLOCK, Items.BRAIN_CORAL_BLOCK),
            Pair.of(WANDERING_TRADER_EMERALD_BUBBLE_CORAL_BLOCK, Items.BUBBLE_CORAL_BLOCK),
            Pair.of(WANDERING_TRADER_EMERALD_FIRE_CORAL_BLOCK, Items.FIRE_CORAL_BLOCK),
            Pair.of(WANDERING_TRADER_EMERALD_HORN_CORAL_BLOCK, Items.HORN_CORAL_BLOCK),
            Pair.of(WANDERING_TRADER_EMERALD_TUBE_CORAL_BLOCK, Items.TUBE_CORAL_BLOCK)
        )) {
            context.register(
                entry.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(entry.getRight()), 8, 1, 0.05F, Optional.empty(), List.of())
            );
        }
    ...
    private static void registerWanderingTraderFlowers(final BootstrapContext<VillagerTrade> context) {
        context.register(
            ...
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.BLUE_ORCHID), 8, 1, 0.05F, Optional.empty(), List.of())
        );

        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(WANDERING_TRADER_EMERALD_DANDELION, Items.DANDELION),
            Pair.of(WANDERING_TRADER_EMERALD_POPPY, Items.POPPY),
            Pair.of(WANDERING_TRADER_EMERALD_ALLIUM, Items.ALLIUM),
            Pair.of(WANDERING_TRADER_EMERALD_AZURE_BLUET, Items.AZURE_BLUET),
            Pair.of(WANDERING_TRADER_EMERALD_RED_TULIP, Items.RED_TULIP),
            Pair.of(WANDERING_TRADER_EMERALD_ORANGE_TULIP, Items.ORANGE_TULIP),
            Pair.of(WANDERING_TRADER_EMERALD_WHITE_TULIP, Items.WHITE_TULIP),
            Pair.of(WANDERING_TRADER_EMERALD_PINK_TULIP, Items.PINK_TULIP),
            Pair.of(WANDERING_TRADER_EMERALD_OXEYE_DAISY, Items.OXEYE_DAISY),
            Pair.of(WANDERING_TRADER_EMERALD_CORNFLOWER, Items.CORNFLOWER),
            Pair.of(WANDERING_TRADER_EMERALD_WILDFLOWERS, Items.WILDFLOWERS),
            Pair.of(WANDERING_TRADER_EMERALD_DRY_TALL_GRASS, Items.DRY_TALL_GRASS)
        )) {
            context.register(
                entry.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(entry.getRight()), 12, 1, 0.05F, Optional.empty(), List.of())
            );
        }
        ...
        context.register(
            ...
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.LILY_OF_THE_VALLEY), 7, 1, 0.05F, Optional.empty(), List.of())
        );
        context.register(
            WANDERING_TRADER_EMERALD_OPEN_EYEBLOSSOM,
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.OPEN_EYEBLOSSOM), 7, 1, 0.05F, Optional.empty(), List.of())
        );
    }

    private static void registerWanderingTraderSeeds(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(WANDERING_TRADER_EMERALD_WHEAT_SEEDS, Items.WHEAT_SEEDS),
            Pair.of(WANDERING_TRADER_EMERALD_BEETROOT_SEEDS, Items.BEETROOT_SEEDS),
            Pair.of(WANDERING_TRADER_EMERALD_PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS),
            Pair.of(WANDERING_TRADER_EMERALD_MELON_SEEDS, Items.MELON_SEEDS)
        )) {
            context.register(
                entry.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(entry.getRight()), 12, 1, 0.05F, Optional.empty(), List.of())
    ...
    private static void registerWanderingTraderSaplings(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(WANDERING_TRADER_EMERALD_ACACIA_SAPLING, Items.ACACIA_SAPLING),
            Pair.of(WANDERING_TRADER_EMERALD_BIRCH_SAPLING, Items.BIRCH_SAPLING),
            Pair.of(WANDERING_TRADER_EMERALD_DARK_OAK_SAPLING, Items.DARK_OAK_SAPLING),
            Pair.of(WANDERING_TRADER_EMERALD_JUNGLE_SAPLING, Items.JUNGLE_SAPLING),
            Pair.of(WANDERING_TRADER_EMERALD_OAK_SAPLING, Items.OAK_SAPLING),
            Pair.of(WANDERING_TRADER_EMERALD_SPRUCE_SAPLING, Items.SPRUCE_SAPLING),
            Pair.of(WANDERING_TRADER_EMERALD_CHERRY_SAPLING, Items.CHERRY_SAPLING),
            Pair.of(WANDERING_TRADER_EMERALD_PALE_OAK_SAPLING, Items.PALE_OAK_SAPLING),
            Pair.of(WANDERING_TRADER_EMERALD_MANGROVE_PROPAGULE, Items.MANGROVE_PROPAGULE)
        )) {
            context.register(
                entry.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(entry.getRight()), 8, 1, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerWanderingTraderDyes(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(WANDERING_TRADER_EMERALD_RED_DYE, Items.RED_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_WHITE_DYE, Items.WHITE_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_BLUE_DYE, Items.BLUE_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_PINK_DYE, Items.PINK_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_BLACK_DYE, Items.BLACK_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_GREEN_DYE, Items.GREEN_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_LIGHT_GRAY_DYE, Items.LIGHT_GRAY_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_MAGENTA_DYE, Items.MAGENTA_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_YELLOW_DYE, Items.YELLOW_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_GRAY_DYE, Items.GRAY_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_PURPLE_DYE, Items.PURPLE_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_LIGHT_BLUE_DYE, Items.LIGHT_BLUE_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_LIME_DYE, Items.LIME_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_ORANGE_DYE, Items.ORANGE_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_BROWN_DYE, Items.BROWN_DYE),
            Pair.of(WANDERING_TRADER_EMERALD_CYAN_DYE, Items.CYAN_DYE)
        )) {
            context.register(
                entry.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(entry.getRight(), 3), 12, 1, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerMasonLevelFourTerracotta(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> block : List.of(
            Pair.of(MASON_4_EMERALD_ORANGE_TERRACOTTA, Items.ORANGE_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_WHITE_TERRACOTTA, Items.WHITE_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_BLUE_TERRACOTTA, Items.BLUE_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_LIGHT_BLUE_TERRACOTTA, Items.LIGHT_BLUE_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_GRAY_TERRACOTTA, Items.GRAY_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_LIGHT_GRAY_TERRACOTTA, Items.LIGHT_GRAY_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_BLACK_TERRACOTTA, Items.BLACK_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_RED_TERRACOTTA, Items.RED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_PINK_TERRACOTTA, Items.PINK_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_MAGENTA_TERRACOTTA, Items.MAGENTA_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_LIME_TERRACOTTA, Items.LIME_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_GREEN_TERRACOTTA, Items.GREEN_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_CYAN_TERRACOTTA, Items.CYAN_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_PURPLE_TERRACOTTA, Items.PURPLE_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_YELLOW_TERRACOTTA, Items.YELLOW_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_BROWN_TERRACOTTA, Items.BROWN_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_ORANGE_GLAZED_TERRACOTTA, Items.ORANGE_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_WHITE_GLAZED_TERRACOTTA, Items.WHITE_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_BLUE_GLAZED_TERRACOTTA, Items.BLUE_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_LIGHT_BLUE_GLAZED_TERRACOTTA, Items.LIGHT_BLUE_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_GRAY_GLAZED_TERRACOTTA, Items.GRAY_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_LIGHT_GRAY_GLAZED_TERRACOTTA, Items.LIGHT_GRAY_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_BLACK_GLAZED_TERRACOTTA, Items.BLACK_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_RED_GLAZED_TERRACOTTA, Items.RED_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_PINK_GLAZED_TERRACOTTA, Items.PINK_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_MAGENTA_GLAZED_TERRACOTTA, Items.MAGENTA_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_LIME_GLAZED_TERRACOTTA, Items.LIME_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_GREEN_GLAZED_TERRACOTTA, Items.GREEN_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_CYAN_GLAZED_TERRACOTTA, Items.CYAN_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_PURPLE_GLAZED_TERRACOTTA, Items.PURPLE_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_YELLOW_GLAZED_TERRACOTTA, Items.YELLOW_GLAZED_TERRACOTTA),
            Pair.of(MASON_4_EMERALD_BROWN_GLAZED_TERRACOTTA, Items.BROWN_GLAZED_TERRACOTTA)
        )) {
            register(
                context,
                block.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(block.getRight()), 12, 15, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerMasonLevelThreeBlocks(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> block : List.of(
            Pair.of(MASON_3_EMERALD_DRIPSTONE_BLOCK, Items.DRIPSTONE_BLOCK),
            Pair.of(MASON_3_EMERALD_POLISHED_ANDESITE, Items.POLISHED_ANDESITE),
            Pair.of(MASON_3_EMERALD_POLISHED_DIORITE, Items.POLISHED_DIORITE),
            Pair.of(MASON_3_EMERALD_POLISHED_GRANTITE, Items.POLISHED_GRANITE)
        )) {
            register(
                context,
                block.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(block.getRight(), 4), 16, 10, 0.05F, Optional.empty(), List.of())
            );
        }
    }

    private static void registerMasonLevelThreeStones(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> stone : List.of(
            Pair.of(MASON_3_GRANITE_EMERALD, Items.GRANITE), Pair.of(MASON_3_ANDESITE_EMERALD, Items.ANDESITE), Pair.of(MASON_3_DIORITE_EMERALD, Items.DIORITE)
        )) {
            register(
                context,
                stone.getLeft(),
                new VillagerTrade(new TradeCost(stone.getRight(), 16), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerBoatTrades(final BootstrapContext<VillagerTrade> context, final HolderGetter<VillagerType> villagerVariants) {
        for (ImmutableTriple<ResourceKey<VillagerTrade>, Item, List<ResourceKey<VillagerType>>> entry : List.of(
            ImmutableTriple.of(FISHERMAN_5_OAK_BOAT_EMERALD, Items.OAK_BOAT, List.of(VillagerType.PLAINS)),
            ImmutableTriple.of(FISHERMAN_5_SPRUCE_BOAT_EMERALD, Items.SPRUCE_BOAT, List.of(VillagerType.TAIGA, VillagerType.SNOW)),
            ImmutableTriple.of(FISHERMAN_5_JUNGLE_BOAT_EMERALD, Items.JUNGLE_BOAT, List.of(VillagerType.DESERT, VillagerType.JUNGLE)),
            ImmutableTriple.of(FISHERMAN_5_ACACIA_BOAT_EMERALD, Items.ACACIA_BOAT, List.of(VillagerType.SAVANNA)),
            ImmutableTriple.of(FISHERMAN_5_DARK_OAK_BOAT_EMERALD, Items.DARK_OAK_BOAT, List.of(VillagerType.SWAMP))
        )) {
            ResourceKey<VillagerTrade> resouceKey = entry.left;
            Item item = entry.middle;
            register(
                context,
                resouceKey,
                new VillagerTrade(
                    ...
                    30,
                    0.05F,
                    villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, entry.right)),
                    List.of()
                )
            );
        }
    ...
    private static void registerWoolSales(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(SHEPHERD_1_WHITE_WOOL_EMERALD, Items.WHITE_WOOL),
            Pair.of(SHEPHERD_1_BROWN_WOOL_EMERALD, Items.BROWN_WOOL),
            Pair.of(SHEPHERD_1_GRAY_WOOL_EMERALD, Items.GRAY_WOOL),
            Pair.of(SHEPHERD_1_BLACK_WOOL_EMERALD, Items.BLACK_WOOL)
        )) {
            register(
                context,
                entry.getLeft(),
                new VillagerTrade(new TradeCost(entry.getRight(), 18), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerLevelTwoDyeTrades(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(SHEPHERD_2_WHITE_DYE_EMERALD, Items.WHITE_DYE),
            Pair.of(SHEPHERD_2_GRAY_DYE_EMERALD, Items.GRAY_DYE),
            Pair.of(SHEPHERD_2_BLACK_DYE_EMERALD, Items.BLACK_DYE),
            Pair.of(SHEPHERD_2_LIGHT_BLUE_DYE_EMERALD, Items.LIGHT_BLUE_DYE),
            Pair.of(SHEPHERD_2_LIME_DYE_EMERALD, Items.LIME_DYE)
        )) {
            register(
                context,
                entry.getLeft(),
                new VillagerTrade(new TradeCost(entry.getRight(), 12), new ItemStackTemplate(Items.EMERALD), 16, 10, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerLevelThreeDyeTrades(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(SHEPHERD_3_YELLOW_DYE_EMERALD, Items.YELLOW_DYE),
            Pair.of(SHEPHERD_3_LIGHT_GRAY_DYE_EMERALD, Items.LIGHT_GRAY_DYE),
            Pair.of(SHEPHERD_3_ORANGE_DYE_EMERALD, Items.ORANGE_DYE),
            Pair.of(SHEPHERD_3_RED_DYE_EMERALD, Items.RED_DYE),
            Pair.of(SHEPHERD_3_PINK_DYE_EMERALD, Items.PINK_DYE)
        )) {
            register(
                context,
                entry.getLeft(),
                new VillagerTrade(new TradeCost(entry.getRight(), 12), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerLevelFourDyeTrades(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(SHEPHERD_4_BROWN_DYE_EMERALD, Items.BROWN_DYE),
            Pair.of(SHEPHERD_4_PURPLE_DYE_EMERALD, Items.PURPLE_DYE),
            Pair.of(SHEPHERD_4_BLUE_DYE_EMERALD, Items.BLUE_DYE),
            Pair.of(SHEPHERD_4_GREEN_DYE_EMERALD, Items.GREEN_DYE),
            Pair.of(SHEPHERD_4_MAGENTA_DYE_EMERALD, Items.MAGENTA_DYE),
            Pair.of(SHEPHERD_4_CYAN_DYE_EMERALD, Items.CYAN_DYE)
        )) {
            register(
                context,
                entry.getLeft(),
                new VillagerTrade(new TradeCost(entry.getRight(), 12), new ItemStackTemplate(Items.EMERALD), 16, 30, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerWoolPurchases(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(SHEPHERD_2_EMERALD_WHITE_WOOL, Items.WHITE_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_ORANGE_WOOL, Items.ORANGE_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_MAGENTA_WOOL, Items.MAGENTA_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_BLUE_WOOL, Items.BLUE_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_LIGHT_BLUE_WOOL, Items.LIGHT_BLUE_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_YELLOW_WOOL, Items.YELLOW_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_LIME_WOOL, Items.LIME_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_PINK_WOOL, Items.PINK_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_GRAY_WOOL, Items.GRAY_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_LIGHT_GRAY_WOOL, Items.LIGHT_GRAY_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_CYAN_WOOL, Items.CYAN_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_PURPLE_WOOL, Items.PURPLE_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_BROWN_WOOL, Items.BROWN_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_GREEN_WOOL, Items.GREEN_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_RED_WOOL, Items.RED_WOOL),
            Pair.of(SHEPHERD_2_EMERALD_BLACK_WOOL, Items.BLACK_WOOL)
        )) {
            register(
                context,
                entry.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(entry.getRight()), 16, 5, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerCarpetPurchases(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(SHEPHERD_2_EMERALD_WHITE_CARPET, Items.WHITE_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_ORANGE_CARPET, Items.ORANGE_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_MAGENTA_CARPET, Items.MAGENTA_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_BLUE_CARPET, Items.BLUE_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_LIGHT_BLUE_CARPET, Items.LIGHT_BLUE_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_YELLOW_CARPET, Items.YELLOW_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_LIME_CARPET, Items.LIME_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_PINK_CARPET, Items.PINK_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_GRAY_CARPET, Items.GRAY_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_LIGHT_GRAY_CARPET, Items.LIGHT_GRAY_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_CYAN_CARPET, Items.CYAN_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_PURPLE_CARPET, Items.PURPLE_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_BROWN_CARPET, Items.BROWN_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_GREEN_CARPET, Items.GREEN_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_RED_CARPET, Items.RED_CARPET),
            Pair.of(SHEPHERD_2_EMERALD_BLACK_CARPET, Items.BLACK_CARPET)
        )) {
            register(
                context,
                entry.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(entry.getRight(), 4), 16, 5, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerBedTrades(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(SHEPHERD_3_EMERALD_WHITE_BED, Items.WHITE_BED),
            Pair.of(SHEPHERD_3_EMERALD_ORANGE_BED, Items.ORANGE_BED),
            Pair.of(SHEPHERD_3_EMERALD_MAGENTA_BED, Items.MAGENTA_BED),
            Pair.of(SHEPHERD_3_EMERALD_BLUE_BED, Items.BLUE_BED),
            Pair.of(SHEPHERD_3_EMERALD_LIGHT_BLUE_BED, Items.LIGHT_BLUE_BED),
            Pair.of(SHEPHERD_3_EMERALD_YELLOW_BED, Items.YELLOW_BED),
            Pair.of(SHEPHERD_3_EMERALD_LIME_BED, Items.LIME_BED),
            Pair.of(SHEPHERD_3_EMERALD_PINK_BED, Items.PINK_BED),
            Pair.of(SHEPHERD_3_EMERALD_GRAY_BED, Items.GRAY_BED),
            Pair.of(SHEPHERD_3_EMERALD_LIGHT_GRAY_BED, Items.LIGHT_GRAY_BED),
            Pair.of(SHEPHERD_3_EMERALD_CYAN_BED, Items.CYAN_BED),
            Pair.of(SHEPHERD_3_EMERALD_PURPLE_BED, Items.PURPLE_BED),
            Pair.of(SHEPHERD_3_EMERALD_BROWN_BED, Items.BROWN_BED),
            Pair.of(SHEPHERD_3_EMERALD_GREEN_BED, Items.GREEN_BED),
            Pair.of(SHEPHERD_3_EMERALD_RED_BED, Items.RED_BED),
            Pair.of(SHEPHERD_3_EMERALD_BLACK_BED, Items.BLACK_BED)
        )) {
            register(
                context,
                entry.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(entry.getRight()), 12, 10, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerShepherdBannerTrades(final BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
            Pair.of(SHEPHERD_4_EMERALD_WHITE_BANNER, Items.WHITE_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_ORANGE_BANNER, Items.ORANGE_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_MAGENTA_BANNER, Items.MAGENTA_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_BLUE_BANNER, Items.BLUE_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_LIGHT_BLUE_BANNER, Items.LIGHT_BLUE_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_YELLOW_BANNER, Items.YELLOW_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_LIME_BANNER, Items.LIME_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_PINK_BANNER, Items.PINK_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_GRAY_BANNER, Items.GRAY_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_LIGHT_GRAY_BANNER, Items.LIGHT_GRAY_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_CYAN_BANNER, Items.CYAN_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_PURPLE_BANNER, Items.PURPLE_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_BROWN_BANNER, Items.BROWN_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_GREEN_BANNER, Items.GREEN_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_RED_BANNER, Items.RED_BANNER),
            Pair.of(SHEPHERD_4_EMERALD_BLACK_BANNER, Items.BLACK_BANNER)
        )) {
            register(
                context,
                entry.getLeft(),
                new VillagerTrade(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(entry.getRight()), 12, 15, 0.05F, Optional.empty(), List.of())
            );
        }
    }
    ...
    private static void registerCartographerBannerTrades(final BootstrapContext<VillagerTrade> context, final HolderGetter<VillagerType> villagerVariants) {
        for (Triple<ResourceKey<VillagerTrade>, Item, List<ResourceKey<VillagerType>>> entry : List.of(
            Triple.of(CARTOGRAPHER_4_EMERALD_WHITE_BANNER, Items.WHITE_BANNER, List.of(VillagerType.SNOW, VillagerType.PLAINS)),
            Triple.of(CARTOGRAPHER_4_EMERALD_ORANGE_BANNER, Items.ORANGE_BANNER, List.of(VillagerType.SAVANNA, VillagerType.DESERT)),
            Triple.of(CARTOGRAPHER_4_EMERALD_MAGENTA_BANNER, Items.MAGENTA_BANNER, List.of(VillagerType.SAVANNA)),
            Triple.of(CARTOGRAPHER_4_EMERALD_BLUE_BANNER, Items.BLUE_BANNER, List.of(VillagerType.SNOW, VillagerType.TAIGA)),
            Triple.of(CARTOGRAPHER_4_EMERALD_LIGHT_BLUE_BANNER, Items.LIGHT_BLUE_BANNER, List.of(VillagerType.SNOW, VillagerType.SWAMP)),
            Triple.of(CARTOGRAPHER_4_EMERALD_YELLOW_BANNER, Items.YELLOW_BANNER, List.of(VillagerType.PLAINS, VillagerType.JUNGLE)),
            Triple.of(CARTOGRAPHER_4_EMERALD_LIME_BANNER, Items.LIME_BANNER, List.of(VillagerType.DESERT, VillagerType.TAIGA)),
            Triple.of(CARTOGRAPHER_4_EMERALD_PINK_BANNER, Items.PINK_BANNER, List.of(VillagerType.TAIGA, VillagerType.PLAINS)),
            Triple.of(CARTOGRAPHER_4_EMERALD_GRAY_BANNER, Items.GRAY_BANNER, List.of(VillagerType.DESERT)),
            Triple.of(CARTOGRAPHER_4_EMERALD_CYAN_BANNER, Items.CYAN_BANNER, List.of(VillagerType.DESERT, VillagerType.SNOW)),
            Triple.of(CARTOGRAPHER_4_EMERALD_PURPLE_BANNER, Items.PURPLE_BANNER, List.of(VillagerType.TAIGA, VillagerType.SWAMP)),
            Triple.of(CARTOGRAPHER_4_EMERALD_BROWN_BANNER, Items.BROWN_BANNER, List.of(VillagerType.PLAINS, VillagerType.JUNGLE)),
            Triple.of(CARTOGRAPHER_4_EMERALD_GREEN_BANNER, Items.GREEN_BANNER, List.of(VillagerType.DESERT, VillagerType.SAVANNA, VillagerType.JUNGLE)),
            Triple.of(CARTOGRAPHER_4_EMERALD_RED_BANNER, Items.RED_BANNER, List.of(VillagerType.SNOW, VillagerType.SAVANNA)),
            Triple.of(CARTOGRAPHER_4_EMERALD_BLACK_BANNER, Items.BLACK_BANNER, List.of(VillagerType.SWAMP))
        )) {
            register(
                context,
                entry.getLeft(),
                new VillagerTrade(
                    new TradeCost(Items.EMERALD, 2),
                    new ItemStackTemplate(entry.getMiddle()),
                    12,
                    15,
                    0.05F,
                    villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, entry.getRight())),
                    List.of()
                )
            );
        }
    ...
    private static void registerBasicExplorerMapTrades(
        ...
        for (VillagerTrades.VillagerExplorerMapEntry entry : List.of(
            new VillagerTrades.VillagerExplorerMapEntry(
            ...
            register(
                ...
                new VillagerTrade(
                    ...
                    5,
                    0.2F,
                    villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, entry.villagerTypes)),
                    List.of(
                        ExplorationMapFunction.makeExplorationMap()
                            .setDestination(entry.structureTagKey)
                            .setMapDecoration(entry.mapDecorationType)
                            .setSearchRadius(100)
                            .setSkipKnownStructures(true)
                            .build(),
                        SetNameFunction.setName(Component.translatable("filled_map." + entry.translationKey), SetNameFunction.Target.ITEM_NAME).build(),
                        FilteredFunction.filtered(
                                new ItemPredicate.Builder()
                                    .of(items, Items.FILLED_MAP)
                                    .withComponents(DataComponentMatchers.Builder.components().any(DataComponents.MAP_ID).build())
    ...
    public static HolderSet<VillagerType> villagerTypeHolderSet(final HolderGetter<VillagerType> villagerVariants, final ResourceKey<VillagerType> resourceKey) {
        ...
        return holder.isPresent() ? HolderSet.direct(holder.get()) : HolderSet.empty();
    }
