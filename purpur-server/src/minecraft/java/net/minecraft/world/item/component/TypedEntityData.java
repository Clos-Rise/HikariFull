...
public final class TypedEntityData<IdType> implements TooltipProvider {
    ...
    public boolean equals(final Object obj) {
        return obj == this || obj instanceof TypedEntityData<?> customData && this.type == customData.type && this.tag.equals(customData.tag);
    }
    ...
    public void addToTooltip(
        ...
        if (this.type.getClass() == EntityType.class) {
            ...
            if (context.isPeaceful() && !type.isTypeAllowedInPeaceful()) { // Paper - do not check entity data for peaceful override - match client as close as possible for compute tooltip api
