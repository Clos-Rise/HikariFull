...
public class Items {
    ...
    public static final Item ACACIA_SHELF = registerBlock(Blocks.ACACIA_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BAMBOO_SHELF = registerBlock(Blocks.BAMBOO_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BIRCH_SHELF = registerBlock(Blocks.BIRCH_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item CHERRY_SHELF = registerBlock(Blocks.CHERRY_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item CRIMSON_SHELF = registerBlock(Blocks.CRIMSON_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item DARK_OAK_SHELF = registerBlock(Blocks.DARK_OAK_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item JUNGLE_SHELF = registerBlock(Blocks.JUNGLE_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item MANGROVE_SHELF = registerBlock(Blocks.MANGROVE_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item OAK_SHELF = registerBlock(Blocks.OAK_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item PALE_OAK_SHELF = registerBlock(Blocks.PALE_OAK_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item SPRUCE_SHELF = registerBlock(Blocks.SPRUCE_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item WARPED_SHELF = registerBlock(Blocks.WARPED_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item CHISELED_BOOKSHELF = registerBlock(
        Blocks.CHISELED_BOOKSHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    ...
    public static final Item TORCH = registerBlock(Blocks.TORCH, (b, p) -> new StandingAndWallBlockItem(b, Blocks.WALL_TORCH, Direction.DOWN, p));
    ...
    public static final Item FURNACE = registerBlock(Blocks.FURNACE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item SOUL_TORCH = registerBlock(Blocks.SOUL_TORCH, (b, p) -> new StandingAndWallBlockItem(b, Blocks.SOUL_WALL_TORCH, Direction.DOWN, p));
    public static final Item COPPER_TORCH = registerBlock(
        Blocks.COPPER_TORCH, (b, p) -> new StandingAndWallBlockItem(b, Blocks.COPPER_WALL_TORCH, Direction.DOWN, p)
    );
    ...
    public static final Item LIGHT = registerBlock(
        Blocks.LIGHT, p -> p.rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(LightBlock.LEVEL, 15))
    );
    public static final Item HAY_BLOCK = registerBlock(Blocks.HAY_BLOCK);
    public static final Item WHITE_CARPET = registerBlock(
        Blocks.WHITE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.WHITE))
    );
    public static final Item ORANGE_CARPET = registerBlock(
        Blocks.ORANGE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.ORANGE))
    );
    public static final Item MAGENTA_CARPET = registerBlock(
        Blocks.MAGENTA_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.MAGENTA))
    );
    public static final Item LIGHT_BLUE_CARPET = registerBlock(
        Blocks.LIGHT_BLUE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_BLUE))
    );
    public static final Item YELLOW_CARPET = registerBlock(
        Blocks.YELLOW_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.YELLOW))
    );
    public static final Item LIME_CARPET = registerBlock(Blocks.LIME_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIME)));
    public static final Item PINK_CARPET = registerBlock(Blocks.PINK_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PINK)));
    public static final Item GRAY_CARPET = registerBlock(Blocks.GRAY_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GRAY)));
    public static final Item LIGHT_GRAY_CARPET = registerBlock(
        Blocks.LIGHT_GRAY_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_GRAY))
    );
    public static final Item CYAN_CARPET = registerBlock(Blocks.CYAN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.CYAN)));
    public static final Item PURPLE_CARPET = registerBlock(
        Blocks.PURPLE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PURPLE))
    );
    public static final Item BLUE_CARPET = registerBlock(Blocks.BLUE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLUE)));
    public static final Item BROWN_CARPET = registerBlock(
        Blocks.BROWN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN))
    );
    public static final Item GREEN_CARPET = registerBlock(
        Blocks.GREEN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN))
    );
    public static final Item RED_CARPET = registerBlock(Blocks.RED_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.RED)));
    public static final Item BLACK_CARPET = registerBlock(
        Blocks.BLACK_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLACK))
    );
    ...
    public static final Item SNIFFER_EGG = registerBlock(Blocks.SNIFFER_EGG, p -> p.rarity(Rarity.UNCOMMON));
    ...
    public static final Item TUBE_CORAL_FAN = registerBlock(
        Blocks.TUBE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.TUBE_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    public static final Item BRAIN_CORAL_FAN = registerBlock(
        Blocks.BRAIN_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.BRAIN_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    public static final Item BUBBLE_CORAL_FAN = registerBlock(
        Blocks.BUBBLE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.BUBBLE_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    public static final Item FIRE_CORAL_FAN = registerBlock(
        Blocks.FIRE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.FIRE_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    public static final Item HORN_CORAL_FAN = registerBlock(
        Blocks.HORN_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.HORN_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    public static final Item DEAD_TUBE_CORAL_FAN = registerBlock(
        Blocks.DEAD_TUBE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    public static final Item DEAD_BRAIN_CORAL_FAN = registerBlock(
        Blocks.DEAD_BRAIN_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    public static final Item DEAD_BUBBLE_CORAL_FAN = registerBlock(
        Blocks.DEAD_BUBBLE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    public static final Item DEAD_FIRE_CORAL_FAN = registerBlock(
        Blocks.DEAD_FIRE_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    public static final Item DEAD_HORN_CORAL_FAN = registerBlock(
        Blocks.DEAD_HORN_CORAL_FAN, (b, p) -> new StandingAndWallBlockItem(b, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, p)
    );
    ...
    public static final Item REDSTONE = registerItem(
        "redstone", createBlockItemWithCustomItemName(Blocks.REDSTONE_WIRE), new Item.Properties().trimMaterial(TrimMaterials.REDSTONE)
    );
    public static final Item REDSTONE_TORCH = registerBlock(
        Blocks.REDSTONE_TORCH, (b, p) -> new StandingAndWallBlockItem(b, Blocks.REDSTONE_WALL_TORCH, Direction.DOWN, p)
    );
    ...
    public static final Item HOPPER = registerBlock(Blocks.HOPPER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item DISPENSER = registerBlock(Blocks.DISPENSER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item DROPPER = registerBlock(Blocks.DROPPER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item TRAPPED_CHEST = registerBlock(Blocks.TRAPPED_CHEST, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item WHITE_HARNESS = registerItem(
        "white_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.WHITE))
    );
    public static final Item ORANGE_HARNESS = registerItem(
        "orange_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.ORANGE))
    );
    public static final Item MAGENTA_HARNESS = registerItem(
        "magenta_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.MAGENTA))
    );
    public static final Item LIGHT_BLUE_HARNESS = registerItem(
        "light_blue_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.LIGHT_BLUE))
    );
    public static final Item YELLOW_HARNESS = registerItem(
        "yellow_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.YELLOW))
    );
    public static final Item LIME_HARNESS = registerItem(
        "lime_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.LIME))
    );
    public static final Item PINK_HARNESS = registerItem(
        "pink_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.PINK))
    );
    public static final Item GRAY_HARNESS = registerItem(
        "gray_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.GRAY))
    );
    public static final Item LIGHT_GRAY_HARNESS = registerItem(
        "light_gray_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.LIGHT_GRAY))
    );
    public static final Item CYAN_HARNESS = registerItem(
        "cyan_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.CYAN))
    );
    public static final Item PURPLE_HARNESS = registerItem(
        "purple_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.PURPLE))
    );
    public static final Item BLUE_HARNESS = registerItem(
        "blue_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BLUE))
    );
    public static final Item BROWN_HARNESS = registerItem(
        "brown_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BROWN))
    );
    public static final Item GREEN_HARNESS = registerItem(
        "green_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.GREEN))
    );
    public static final Item RED_HARNESS = registerItem(
        "red_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.RED))
    );
    public static final Item BLACK_HARNESS = registerItem(
        "black_harness", new Item.Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BLACK))
    );
    public static final Item MINECART = registerItem("minecart", p -> new MinecartItem(EntityType.MINECART, p), new Item.Properties().stacksTo(1));
    public static final Item CHEST_MINECART = registerItem(
        "chest_minecart", p -> new MinecartItem(EntityType.CHEST_MINECART, p), new Item.Properties().stacksTo(1)
    );
    public static final Item FURNACE_MINECART = registerItem(
        "furnace_minecart", p -> new MinecartItem(EntityType.FURNACE_MINECART, p), new Item.Properties().stacksTo(1)
    );
    public static final Item TNT_MINECART = registerItem("tnt_minecart", p -> new MinecartItem(EntityType.TNT_MINECART, p), new Item.Properties().stacksTo(1));
    public static final Item HOPPER_MINECART = registerItem(
        "hopper_minecart", p -> new MinecartItem(EntityType.HOPPER_MINECART, p), new Item.Properties().stacksTo(1)
    );
    public static final Item CARROT_ON_A_STICK = registerItem(
        "carrot_on_a_stick", p -> new FoodOnAStickItem<>(EntityType.PIG, 7, p), new Item.Properties().durability(25)
    );
    public static final Item WARPED_FUNGUS_ON_A_STICK = registerItem(
        "warped_fungus_on_a_stick", p -> new FoodOnAStickItem<>(EntityType.STRIDER, 1, p), new Item.Properties().durability(100)
    );
    ...
    public static final Item OAK_BOAT = registerItem("oak_boat", p -> new BoatItem(EntityType.OAK_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item OAK_CHEST_BOAT = registerItem("oak_chest_boat", p -> new BoatItem(EntityType.OAK_CHEST_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item SPRUCE_BOAT = registerItem("spruce_boat", p -> new BoatItem(EntityType.SPRUCE_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item SPRUCE_CHEST_BOAT = registerItem(
        "spruce_chest_boat", p -> new BoatItem(EntityType.SPRUCE_CHEST_BOAT, p), new Item.Properties().stacksTo(1)
    );
    public static final Item BIRCH_BOAT = registerItem("birch_boat", p -> new BoatItem(EntityType.BIRCH_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item BIRCH_CHEST_BOAT = registerItem(
        "birch_chest_boat", p -> new BoatItem(EntityType.BIRCH_CHEST_BOAT, p), new Item.Properties().stacksTo(1)
    );
    public static final Item JUNGLE_BOAT = registerItem("jungle_boat", p -> new BoatItem(EntityType.JUNGLE_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item JUNGLE_CHEST_BOAT = registerItem(
        "jungle_chest_boat", p -> new BoatItem(EntityType.JUNGLE_CHEST_BOAT, p), new Item.Properties().stacksTo(1)
    );
    public static final Item ACACIA_BOAT = registerItem("acacia_boat", p -> new BoatItem(EntityType.ACACIA_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item ACACIA_CHEST_BOAT = registerItem(
        "acacia_chest_boat", p -> new BoatItem(EntityType.ACACIA_CHEST_BOAT, p), new Item.Properties().stacksTo(1)
    );
    public static final Item CHERRY_BOAT = registerItem("cherry_boat", p -> new BoatItem(EntityType.CHERRY_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item CHERRY_CHEST_BOAT = registerItem(
        "cherry_chest_boat", p -> new BoatItem(EntityType.CHERRY_CHEST_BOAT, p), new Item.Properties().stacksTo(1)
    );
    public static final Item DARK_OAK_BOAT = registerItem("dark_oak_boat", p -> new BoatItem(EntityType.DARK_OAK_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item DARK_OAK_CHEST_BOAT = registerItem(
        "dark_oak_chest_boat", p -> new BoatItem(EntityType.DARK_OAK_CHEST_BOAT, p), new Item.Properties().stacksTo(1)
    );
    public static final Item PALE_OAK_BOAT = registerItem("pale_oak_boat", p -> new BoatItem(EntityType.PALE_OAK_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item PALE_OAK_CHEST_BOAT = registerItem(
        "pale_oak_chest_boat", p -> new BoatItem(EntityType.PALE_OAK_CHEST_BOAT, p), new Item.Properties().stacksTo(1)
    );
    public static final Item MANGROVE_BOAT = registerItem("mangrove_boat", p -> new BoatItem(EntityType.MANGROVE_BOAT, p), new Item.Properties().stacksTo(1));
    public static final Item MANGROVE_CHEST_BOAT = registerItem(
        "mangrove_chest_boat", p -> new BoatItem(EntityType.MANGROVE_CHEST_BOAT, p), new Item.Properties().stacksTo(1)
    );
    public static final Item BAMBOO_RAFT = registerItem("bamboo_raft", p -> new BoatItem(EntityType.BAMBOO_RAFT, p), new Item.Properties().stacksTo(1));
    public static final Item BAMBOO_CHEST_RAFT = registerItem(
        "bamboo_chest_raft", p -> new BoatItem(EntityType.BAMBOO_CHEST_RAFT, p), new Item.Properties().stacksTo(1)
    );
    ...
    public static final Item TEST_INSTANCE_BLOCK = registerBlock(
        Blocks.TEST_INSTANCE_BLOCK, GameMasterBlockItem::new, new Item.Properties().rarity(Rarity.EPIC)
    );
    ...
    public static final Item WOODEN_SHOVEL = registerItem("wooden_shovel", p -> new ShovelItem(ToolMaterial.WOOD, 1.5F, -3.0F, p));
    ...
    public static final Item WOODEN_AXE = registerItem("wooden_axe", p -> new AxeItem(ToolMaterial.WOOD, 6.0F, -3.2F, p));
    public static final Item WOODEN_HOE = registerItem("wooden_hoe", p -> new HoeItem(ToolMaterial.WOOD, 0.0F, -3.0F, p));
    public static final Item COPPER_SWORD = registerItem("copper_sword", new Item.Properties().sword(ToolMaterial.COPPER, 3.0F, -2.4F));
    public static final Item COPPER_SHOVEL = registerItem("copper_shovel", p -> new ShovelItem(ToolMaterial.COPPER, 1.5F, -3.0F, p));
    ...
    public static final Item COPPER_AXE = registerItem("copper_axe", p -> new AxeItem(ToolMaterial.COPPER, 7.0F, -3.2F, p));
    public static final Item COPPER_HOE = registerItem("copper_hoe", p -> new HoeItem(ToolMaterial.COPPER, -1.0F, -2.0F, p));
    public static final Item STONE_SWORD = registerItem("stone_sword", new Item.Properties().sword(ToolMaterial.STONE, 3.0F, -2.4F));
    public static final Item STONE_SHOVEL = registerItem("stone_shovel", p -> new ShovelItem(ToolMaterial.STONE, 1.5F, -3.0F, p));
    ...
    public static final Item STONE_AXE = registerItem("stone_axe", p -> new AxeItem(ToolMaterial.STONE, 7.0F, -3.2F, p));
    public static final Item STONE_HOE = registerItem("stone_hoe", p -> new HoeItem(ToolMaterial.STONE, -1.0F, -2.0F, p));
    public static final Item GOLDEN_SWORD = registerItem("golden_sword", new Item.Properties().sword(ToolMaterial.GOLD, 3.0F, -2.4F));
    public static final Item GOLDEN_SHOVEL = registerItem("golden_shovel", p -> new ShovelItem(ToolMaterial.GOLD, 1.5F, -3.0F, p));
    ...
    public static final Item GOLDEN_AXE = registerItem("golden_axe", p -> new AxeItem(ToolMaterial.GOLD, 6.0F, -3.0F, p));
    public static final Item GOLDEN_HOE = registerItem("golden_hoe", p -> new HoeItem(ToolMaterial.GOLD, 0.0F, -3.0F, p));
    ...
    public static final Item IRON_AXE = registerItem("iron_axe", p -> new AxeItem(ToolMaterial.IRON, 6.0F, -3.1F, p));
    public static final Item IRON_HOE = registerItem("iron_hoe", p -> new HoeItem(ToolMaterial.IRON, -2.0F, -1.0F, p));
    ...
    public static final Item DIAMOND_SHOVEL = registerItem("diamond_shovel", p -> new ShovelItem(ToolMaterial.DIAMOND, 1.5F, -3.0F, p));
    ...
    public static final Item DIAMOND_AXE = registerItem("diamond_axe", p -> new AxeItem(ToolMaterial.DIAMOND, 5.0F, -3.0F, p));
    public static final Item DIAMOND_HOE = registerItem("diamond_hoe", p -> new HoeItem(ToolMaterial.DIAMOND, -3.0F, 0.0F, p));
    ...
    public static final Item NETHERITE_SHOVEL = registerItem(
        "netherite_shovel", p -> new ShovelItem(ToolMaterial.NETHERITE, 1.5F, -3.0F, p), new Item.Properties().fireResistant()
    );
    public static final Item NETHERITE_PICKAXE = registerItem(
        "netherite_pickaxe", new Item.Properties().pickaxe(ToolMaterial.NETHERITE, 1.0F, -2.8F).fireResistant()
    );
    public static final Item NETHERITE_AXE = registerItem(
        "netherite_axe", p -> new AxeItem(ToolMaterial.NETHERITE, 5.0F, -3.0F, p), new Item.Properties().fireResistant()
    );
    public static final Item NETHERITE_HOE = registerItem(
        "netherite_hoe", p -> new HoeItem(ToolMaterial.NETHERITE, -4.0F, 0.0F, p), new Item.Properties().fireResistant()
    );
    ...
    public static final Item LEATHER_CHESTPLATE = registerItem(
        "leather_chestplate", new Item.Properties().humanoidArmor(ArmorMaterials.LEATHER, ArmorType.CHESTPLATE)
    );
    public static final Item LEATHER_LEGGINGS = registerItem(
        "leather_leggings", new Item.Properties().humanoidArmor(ArmorMaterials.LEATHER, ArmorType.LEGGINGS)
    );
    ...
    public static final Item COPPER_CHESTPLATE = registerItem(
        "copper_chestplate", new Item.Properties().humanoidArmor(ArmorMaterials.COPPER, ArmorType.CHESTPLATE)
    );
    ...
    public static final Item CHAINMAIL_CHESTPLATE = registerItem(
        "chainmail_chestplate", new Item.Properties().humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.CHESTPLATE).rarity(Rarity.UNCOMMON)
    );
    public static final Item CHAINMAIL_LEGGINGS = registerItem(
        "chainmail_leggings", new Item.Properties().humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.LEGGINGS).rarity(Rarity.UNCOMMON)
    );
    public static final Item CHAINMAIL_BOOTS = registerItem(
        "chainmail_boots", new Item.Properties().humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.BOOTS).rarity(Rarity.UNCOMMON)
    );
    ...
    public static final Item DIAMOND_LEGGINGS = registerItem(
        "diamond_leggings", new Item.Properties().humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.LEGGINGS)
    );
    ...
    public static final Item GOLDEN_CHESTPLATE = registerItem(
        "golden_chestplate", new Item.Properties().humanoidArmor(ArmorMaterials.GOLD, ArmorType.CHESTPLATE)
    );
    ...
    public static final Item NETHERITE_HELMET = registerItem(
        "netherite_helmet", new Item.Properties().humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.HELMET).fireResistant()
    );
    public static final Item NETHERITE_CHESTPLATE = registerItem(
        "netherite_chestplate", new Item.Properties().humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.CHESTPLATE).fireResistant()
    );
    public static final Item NETHERITE_LEGGINGS = registerItem(
        "netherite_leggings", new Item.Properties().humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.LEGGINGS).fireResistant()
    );
    ...
    public static final Item PAINTING = registerItem("painting", p -> new HangingEntityItem(EntityType.PAINTING, p));
    ...
    public static final Item OAK_SIGN = registerBlock(Blocks.OAK_SIGN, (b, p) -> new SignItem(b, Blocks.OAK_WALL_SIGN, p), new Item.Properties().stacksTo(16));
    public static final Item SPRUCE_SIGN = registerBlock(
        Blocks.SPRUCE_SIGN, (b, p) -> new SignItem(b, Blocks.SPRUCE_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item BIRCH_SIGN = registerBlock(
        Blocks.BIRCH_SIGN, (b, p) -> new SignItem(b, Blocks.BIRCH_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item JUNGLE_SIGN = registerBlock(
        Blocks.JUNGLE_SIGN, (b, p) -> new SignItem(b, Blocks.JUNGLE_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item ACACIA_SIGN = registerBlock(
        Blocks.ACACIA_SIGN, (b, p) -> new SignItem(b, Blocks.ACACIA_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item CHERRY_SIGN = registerBlock(
        Blocks.CHERRY_SIGN, (b, p) -> new SignItem(b, Blocks.CHERRY_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item DARK_OAK_SIGN = registerBlock(
        Blocks.DARK_OAK_SIGN, (b, p) -> new SignItem(b, Blocks.DARK_OAK_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item PALE_OAK_SIGN = registerBlock(
        Blocks.PALE_OAK_SIGN, (b, p) -> new SignItem(b, Blocks.PALE_OAK_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item MANGROVE_SIGN = registerBlock(
        Blocks.MANGROVE_SIGN, (b, p) -> new SignItem(b, Blocks.MANGROVE_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item BAMBOO_SIGN = registerBlock(
        Blocks.BAMBOO_SIGN, (b, p) -> new SignItem(b, Blocks.BAMBOO_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item CRIMSON_SIGN = registerBlock(
        Blocks.CRIMSON_SIGN, (b, p) -> new SignItem(b, Blocks.CRIMSON_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item WARPED_SIGN = registerBlock(
        Blocks.WARPED_SIGN, (b, p) -> new SignItem(b, Blocks.WARPED_WALL_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item OAK_HANGING_SIGN = registerBlock(
        Blocks.OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.OAK_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item SPRUCE_HANGING_SIGN = registerBlock(
        Blocks.SPRUCE_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.SPRUCE_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item BIRCH_HANGING_SIGN = registerBlock(
        Blocks.BIRCH_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.BIRCH_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item JUNGLE_HANGING_SIGN = registerBlock(
        Blocks.JUNGLE_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.JUNGLE_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item ACACIA_HANGING_SIGN = registerBlock(
        Blocks.ACACIA_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.ACACIA_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item CHERRY_HANGING_SIGN = registerBlock(
        Blocks.CHERRY_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.CHERRY_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item DARK_OAK_HANGING_SIGN = registerBlock(
        Blocks.DARK_OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.DARK_OAK_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item PALE_OAK_HANGING_SIGN = registerBlock(
        Blocks.PALE_OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.PALE_OAK_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item MANGROVE_HANGING_SIGN = registerBlock(
        Blocks.MANGROVE_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.MANGROVE_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item BAMBOO_HANGING_SIGN = registerBlock(
        Blocks.BAMBOO_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.BAMBOO_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item CRIMSON_HANGING_SIGN = registerBlock(
        Blocks.CRIMSON_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.CRIMSON_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item WARPED_HANGING_SIGN = registerBlock(
        Blocks.WARPED_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.WARPED_WALL_HANGING_SIGN, p), new Item.Properties().stacksTo(16)
    );
    public static final Item BUCKET = registerItem("bucket", p -> new BucketItem(Fluids.EMPTY, p), new Item.Properties().stacksTo(16));
    public static final Item WATER_BUCKET = registerItem(
        "water_bucket", p -> new BucketItem(Fluids.WATER, p), new Item.Properties().craftRemainder(BUCKET).stacksTo(1)
    );
    public static final Item LAVA_BUCKET = registerItem(
        "lava_bucket", p -> new BucketItem(Fluids.LAVA, p), new Item.Properties().craftRemainder(BUCKET).stacksTo(1)
    );
    ...
    public static final Item PUFFERFISH_BUCKET = registerItem(
        "pufferfish_bucket",
        p -> new MobBucketItem(EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p),
    ...
    public static final Item SALMON_BUCKET = registerItem(
        "salmon_bucket",
        p -> new MobBucketItem(EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p),
    ...
    public static final Item COD_BUCKET = registerItem(
        "cod_bucket",
        p -> new MobBucketItem(EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p),
    ...
    public static final Item TROPICAL_FISH_BUCKET = registerItem(
        ...
        p -> new MobBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p),
    ...
    public static final Item AXOLOTL_BUCKET = registerItem(
        "axolotl_bucket",
        p -> new MobBucketItem(EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_EMPTY_AXOLOTL, p),
        new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
    );
    public static final Item TADPOLE_BUCKET = registerItem(
        "tadpole_bucket",
        p -> new MobBucketItem(EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_EMPTY_TADPOLE, p),
        new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
    );
    ...
    public static final Item CRAFTER = registerBlock(Blocks.CRAFTER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item BREWING_STAND = registerBlock(Blocks.BREWING_STAND, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item ITEM_FRAME = registerItem("item_frame", p -> new ItemFrameItem(EntityType.ITEM_FRAME, p));
    public static final Item GLOW_ITEM_FRAME = registerItem("glow_item_frame", p -> new ItemFrameItem(EntityType.GLOW_ITEM_FRAME, p));
    ...
    public static final Item NETHERITE_HORSE_ARMOR = registerItem(
        "netherite_horse_armor", new Item.Properties().horseArmor(ArmorMaterials.NETHERITE).fireResistant()
    );
    ...
    public static final Item COMMAND_BLOCK_MINECART = registerItem(
        "command_block_minecart", p -> new MinecartItem(EntityType.COMMAND_BLOCK_MINECART, p), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
    );
    ...
    public static final Item WHITE_BANNER = registerBlock(
        Blocks.WHITE_BANNER,
        (b, p) -> new BannerItem(b, Blocks.WHITE_WALL_BANNER, p),
    ...
    public static final Item MUSIC_DISC_LAVA_CHICKEN = registerItem(
        "music_disc_lava_chicken", new Item.Properties().stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(JukeboxSongs.LAVA_CHICKEN)
    );
    ...
    public static final Item MUSIC_DISC_TEARS = registerItem(
        "music_disc_tears", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.TEARS)
    );
    ...
    public static final Item NETHERITE_NAUTILUS_ARMOR = registerItem(
        "netherite_nautilus_armor", new Item.Properties().nautilusArmor(ArmorMaterials.NETHERITE).fireResistant()
    );
    ...
    public static final Item SMOKER = registerBlock(Blocks.SMOKER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BLAST_FURNACE = registerBlock(Blocks.BLAST_FURNACE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item COPPER_GOLEM_STATUE = registerBlock(
    ...
    public static final Item EXPOSED_COPPER_GOLEM_STATUE = registerBlock(
        Blocks.EXPOSED_COPPER_GOLEM_STATUE,
        new Item.Properties()
            .component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING))
    );
    public static final Item WEATHERED_COPPER_GOLEM_STATUE = registerBlock(
        Blocks.WEATHERED_COPPER_GOLEM_STATUE,
        new Item.Properties()
            .component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING))
    );
    public static final Item OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(
        Blocks.OXIDIZED_COPPER_GOLEM_STATUE,
        new Item.Properties()
            .component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING))
    );
    public static final Item WAXED_COPPER_GOLEM_STATUE = registerBlock(
        Blocks.WAXED_COPPER_GOLEM_STATUE,
        new Item.Properties()
            .component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING))
    );
    public static final Item WAXED_EXPOSED_COPPER_GOLEM_STATUE = registerBlock(
        Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE,
        new Item.Properties()
            .component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING))
    );
    public static final Item WAXED_WEATHERED_COPPER_GOLEM_STATUE = registerBlock(
        Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE,
        new Item.Properties()
            .component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING))
    );
    public static final Item WAXED_OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(
