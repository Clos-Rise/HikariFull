...
public final class BundleContents implements TooltipComponent {
    ...
    public boolean equals(final Object obj) {
        return this == obj || obj instanceof BundleContents contents && this.items.equals(contents.items);
    }
    ...
    public static class Mutable {
        ...
        public int tryInsert(final ItemStack itemsToAdd) {
            ...
            if (stackIndex != BundleContents.NO_STACK_INDEX) {
        ...
        public void toggleSelectedItem(final int selectedItem) {
            this.selectedItem = this.selectedItem != selectedItem && !this.indexIsOutsideAllowedBounds(selectedItem)
                ? selectedItem
        ...
        public @Nullable ItemStack removeOne() {
            ...
            this.toggleSelectedItem(BundleContents.NO_SELECTED_ITEM_INDEX);
            return stack;
        }
