...
public class Guardian extends Monster {
    ...
    public void setActiveAttackTarget(final int entityId) {
    ...
    private static class GuardianMoveControl extends org.purpurmc.purpur.controller.WaterMoveControllerWASD { // Purpur - Ridables
        ...
        public void vanillaTick() { // Purpur - Ridables
            if (this.operation == MoveControl.Operation.MOVE_TO && !this.guardian.getNavigation().isDone()) {
                ...
                double cos = Math.cos(this.guardian.getYRot() * Mth.DEG_TO_RAD);
                double sin = Math.sin(this.guardian.getYRot() * Mth.DEG_TO_RAD);
