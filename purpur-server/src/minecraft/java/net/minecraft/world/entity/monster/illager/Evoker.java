...
public class Evoker extends SpellcasterIllager {
    ...
    protected boolean considersEntityAsAlly(final Entity other) {
        return other == this
            ...
            || other instanceof Vex vex && vex.getOwner() != null && this.considersEntityAsAlly(vex.getOwner());
    }
    ...
    public void setWololoTarget(final @Nullable Sheep wololoTarget) {
    ...
    private class EvokerAttackSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        protected void performSpellCasting() {
            ...
            if (Evoker.this.distanceToSqr(target) < 9.0) {
                ...
                for (int i = 0; i < 8; i++) {
                    float angle = angleTowardsTarget + i * Mth.PI * 2.0F / 8.0F + (float) (Math.PI * 2.0 / 5.0);
